...
class RecipeProvider extends net.minecraft.data.recipes.RecipeProvider {
    RecipeProvider(DataGenerator generator) {
        super(generator);
    }
    ...
    protected void buildCraftingRecipes(@NotNull Consumer<FinishedRecipe> consumer) {
        ...
        ShapelessRecipeBuilder.shapeless(ArsEngItems.SOURCE_ACCEPTOR_PART)
        ...
        ShapelessRecipeBuilder.shapeless(ArsEngBlocks.SOURCE_ACCEPTOR)
