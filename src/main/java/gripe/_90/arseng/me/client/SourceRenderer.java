...
public class SourceRenderer implements IAEStackRenderHandler<SourceKey> {
    ...
    public static final Material SOURCE = new Material(InventoryMenu.BLOCK_ATLAS,
            new ResourceLocation("ars_nouveau", "blocks/mana_still"));
    ...
    @Override
    public void drawOnBlockFace(PoseStack poseStack, MultiBufferSource buffers, SourceKey what, float scale,
            int combinedLight) {
